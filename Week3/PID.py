...
class TurtlebotPIDController:
    def __init__(self):
        ...
        self.goal_x = 5.0  # Goal x-coordinate
        self.goal_y = 5.0  # Goal y-coordinate
        
        # PID coefficients for linear and angular velocities
        self.Kp_linear = 0.5
        self.Ki_linear = 0.0
        self.Kd_linear = 0.1
        ...
        # Initializing variables to store previous errors and accumulated errors
        ...
        # Setting maximum linear and angular velocities
        ...
        # Initializing variables to store current position and orientation
        self.current_x = 0.0
        self.current_y = 0.0
    ...
    def calculate_control(self):
        ...
        # Calculating errors for linear and angular positions
        ...
        # Limiting velocities to maximum values
